...
projectController.get("/:id", createAuthorizationMiddleware(Project), (req, res) => {
...
projectController.get("/", createAuthorizationMiddleware(Project), (req, res) => {
  Project.find()
    .then(projects => {
      if (!projects) {
...
projectController.put("/:id", createAuthorizationMiddleware(Project), (req, res) => {
...
projectController.patch(
  "/:id",
  createAuthorizationMiddleware(Project),
  (req, res) => {
